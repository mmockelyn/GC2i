...
// 		toastr.success("Bonjour, <?php echo htmlentities(trim($_SESSION['login'])); ?>", "Votre compte et profile est à jour.", opts);
// 	}, 3000);
...
// </script>
<?php
$sql_facture_client = mysql_query("SELECT count(*) FROM intervention");
$somme_facture_client = mysql_result($sql_facture_client,0);
...
<div class="row">
	<div class="col-sm-3">
		...
		<div class="tile-stats">
			...
			<div data-delay="0" data-duration="2500" data-postfix="" data-prefix="" data-end="<?php echo $somme_facture_client; ?>" data-start="0" class="num">0</div>
	...
	<div class="col-sm-3">
		...
		<div class="tile-stats tile-green">
			...
			<div class="num" data-start="0" data-end="<?php echo $somme_client; ?>" data-postfix="" data-duration="1500" data-delay="600">0</div>
...
<?php
$sql_news = mysql_query("SELECT * FROM maj ORDER BY version_latest DESC");
...
<div class="row">
	<div class="col-md-12">
		...
		<div data-collapsed="0" class="panel panel-default panel-shadow"><!-- to apply shadow add class "panel-shadow" -->
			...
			<!-- panel head -->
			<div class="panel-heading">
				<div class="panel-title"><?php echo $donnee_news['Title']; ?></div>
			</div>
			
			<!-- panel body -->
			<div class="panel-body">
				
			<?php echo $donnee_news['desc']; ?>
