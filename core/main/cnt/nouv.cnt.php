	...
	<div class="tab-content">
		...
		<div id="tab2-2" class="tab-pane">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label for="street" class="control-label">N° de Contrat</label>
						<input type="text" placeholder="000-000-AAA" data-is-regex="true" data-mask="CNT000-000-AAA" class="form-control" name="">
					</div>
				</div>
		...
		<div id="tab2-3" class="tab-pane">
			...
			<div class="row">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" placeholder="Marque du Matériel" name="marque">
						</div>
					</div>
					<br>
					<div class="form-group">
