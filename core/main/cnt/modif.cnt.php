...
$donnee_cnt = mysql_fetch_array($sql_inter);
?>
...
<hr />
				...
				<form role="form" class="form-horizontal form-groups-bordered" method="post" action="valid.modif.cnt.php">

					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">ID Contrat</label>
						
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="Id du contrat de Maintenance" name="idcnt" value="<?php echo $donnee_cnt['idcnt']; ?>">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-3 control-label">Etat du contrat</label>
						
						<div class="col-sm-5">
							<select class="form-control" name="etat_cnt">
