...
$sql_inter = mysql_query("SELECT * FROM intervention WHERE idintervention =" .$idintervention);
...
<hr />
				...
				<form role="form" class="form-horizontal form-groups-bordered" method="post" action="valid.inserttask.inter.php">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="Id Intervention" name="idintervention" value="<?php echo $donnee_inter['idintervention']; ?>">
						</div>
					</div>
