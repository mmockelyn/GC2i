...
<hr />
				...
				<form role="form" class="form-horizontal form-groups-bordered" method="post" action="valid.modif.client.php">

					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label">ID Client</label>
						
						<div class="col-sm-6">
							<input type="text" class="form-control" id="field-1" placeholder="Nom" name="idclient" value="<?php echo $donnee_client['idclient']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" name="civilite" disabled="">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="Adresse Mail" id="field-1" class="form-control" name="mail" value="<?php echo $donnee_client['mail']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="Raison social" id="field-1" class="form-control" name="raison_social" value="<?php echo $donnee_client['raison_social']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="N° de Siret" id="field-1" class="form-control" name="siret" value="<?php echo $donnee_client['siret']; ?>">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" placeholder="N° TVA Intracommunautaire" id="field-1" class="form-control" name="tva_intra" value="<?php echo $donnee_client['tva_intra']; ?>">
						</div>
					</div>
